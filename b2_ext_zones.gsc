...
zone_hud(raw_names)
{
	...
	/* You shouldn't play real games with this extension, but if you insist on doing so, at least comment out this thread, since it's super heavy for the game to handle */
